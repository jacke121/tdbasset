...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <label class="radio-inline"><input type="radio" name="status" {{ (isset($zq->status)&&($zq->status==1)?'checked':'') }} value="1">通过</label>
        <label class="radio-inline"><input type="radio" name="status" {{ (isset($zq->status)&&($zq->status==0)?'checked':'') }}  value="0">拒绝</label>
    </div>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <label class="radio-inline"><input type="radio" name="delay_scope" {{ (isset($zq->delay_scope)&&($zq->delay_scope==1)?'checked':'') }} value="1">半年内</label>
...
<div class="form-group">
    ...
    <div class="col-sm-6">
        <label class="radio-inline"><input type="radio" name="money_scope" {{ (isset($zq->money_scope)&&($zq->money_scope==1) ?'checked':'') }} value="1">10万以下</label>
