...
<div class="form-group">
	...
	<ul class="list-unstyled inline-line">
		<li>
			<label class="checkbox-inline"><input type="checkbox" name="zq_czfs_sscs" value="1">诉讼催收 报酬比例</label>
			<div class="input-group">
				<input type="text" class="form-control" style="width:200px;" name="zq_czfs_sscs_rate" value="" />
		...
		<li>
			<label class="checkbox-inline"><input type="checkbox" name="zq_czfs_fscs" value="1">非诉催收 报酬比例</label>
			<div class="input-group">
				<input type="text" class="form-control" style="width:200px;" name="zq_czfs_fscs_rate" value="" />
				<div class="input-group-addon">% </div>
			</div>
			<span class="append-info">支付代理方报酬</span>
			<div class="clearfix"></div>
		...
		<li>
			<label class="checkbox-inline"><input type="checkbox" name="zq_czfs_zqzr" value="1">债权转让 折扣比率</label>
			<div class="input-group">
				<input type="text" class="form-control" style="width:200px;" name="zq_czfs_zqzr_rate" value="" />
				<div class="input-group-addon">% </div>
			</div>
...
<div class="form-group">
	...
	<ul class="list-inline">
		<li><label class="checkbox-inline"><input type="checkbox" name="zq_warrant" value="0">他人担保</label></li>
		<li><label class="checkbox-inline"><input type="checkbox" name="zq_warrant" value="1">担保公司</label></li>
		<li><label class="checkbox-inline"><input type="checkbox" name="zq_warrant" value="2">抵押</label></li>
	</ul>
	<ul class="list-inline">
		<li><label class="checkbox-inline"><input type="checkbox" name="zq_warrant" value="3">质押</label></li>
		<li><label class="checkbox-inline"><input type="checkbox" name="zq_warrant" value="4">其他担保</label></li>
		<li><label class="checkbox-inline"><input type="checkbox" name="zq_warrant" value="5">无</label></li>
	</ul>
	</div>
