        ...
        <div class="reg2con">
            ...
            <div class="fl">
                ...
                <div class="int">
                    ...
                    <input type="text" id="username" name="name" placeholder="用户名：6-24个字符，区分大小写" class="user onlyName"
                           minlength="2" onkeyup="value=value.replace(/^ +| +$/g,'')">
                </div>
                <div class="int">
                    <span class="intface pwdface"></span>
                    <input type="password" id="password" name="password" placeholder="密码：6-24个英文、数字组成" class="password"
                           onkeyup="value=value.replace(/[^\w\.\/]/ig,'')"/>
                </div>
                <div class="int">
                    <span class="intface pwd1face"></span>
                    <input id="pwdrepeat" type="password" placeholder="确认密码：重新输入上面填写的密码" name="confirm_password"
                           onkeyup="value=value.replace(/[^\w\.\/]/ig,'')"/>
                </div>
                <!--    <div class="int">
            ...
            <div class="fr reg2r">
                ...
                <p>
                    投贷宝（www.toudaibao.com）由润木财富集团北京投贷宝资本管理有限公司注册并负责运营（以下所称的“本网站”包括网站本身和润木财富集团北京投贷宝资本管理有限公司）。本网站提醒您在注册成为本网站用户前请认真阅读本协议，在充分理解各项条款内容后再选择是否接受本协议，用户一经注册或使用本网站服务即视为同意接受本网站的服务并受以下条款的约束。在您同意以下条款并注册后，将有权依据本协议的条款享受本网站的服务，同时有义务接受本协议条款的约束。</p>
                一、第一章 本网站使用说明
                <p>
                    1、本网站的注册用户必须是依据中华人民共和国法律规定具有完全民事权利能力和民事行为能力，能够独立承担民事责任的自然人，如果注册用户不符合资格，请勿注册，否则本网站有权随时终止您的注册进程及本网站服务，您应对您的注册行为给本网站带来的全部损失承担赔偿责任，且您的监护人对此应当承担连带责任。</p>
                </p>
                <p>2、在使用本网站服务前，用户必须先在本网站完成注册，成为本网站的注册用户（以下简称“用户”）。</p>

                <p>
                    3、在注册和使用本网站服务的所有期间，用户有义务确保个人资料信息的真实、完整且有效，并承诺对个人资料信息及时进行更新。用户所提交的资料和信息包括但不限于电子邮箱、联系电话、通讯地址、个人身份信息、邮政编码、征信信息等。</p>

                <p>
                    4、若本网站经判断认定用户资料存在错误、虚假等嫌疑时，本网站有权终止用户账户，由此产生的任何损失，需用户自己独立承担责任，与本网站无关。在用户向本网站提供的相关信息资料发生变更时，其应当及时向本网站更新相应的信息和资料，如因用户未及时更新信息和资料而导致本网站无法向其提供服务或发生错误，由此产生的一切后果将由用户自己独立承担，与本网站无关。</p>

                <p>
                    5、本网站的协议内容包括但不限于本网站已经发布的或将来可能发布的各类规则。所有规则均是本协议不可分割的一部分，与本协议具有同等的法律效力。本网站有权根据实际需要不时地修改本网站的相关协议，一旦协议内容发生变动，本网站将公布最新的协议内容，请您随时关注本网站，本网站不再单独通知用户。若您在本网站最新协议内容公告变更后继续使用本网站相关服务的，表示您已充分阅读、理解并接受修改后的协议及具体规则内容，您应遵照修改后的协议行使权利和履行义务，若您不同意修改后的协议内容，请停止使用本网站的服务。</p>
                第二章 本网站服务内容
                ...
                第三章 用户信息管理
                <p>
                    1、用户同意本网站在业务运营中收集和储存其信息，包括但不限于其自行提供的资料和信息，以及本网站自行收集、取得的其在本网站的交易记录和使用信息等。本网站收集和储存您的用户信息的主要目的在于可以更好的为其提供服务。</p>
                ...
                第四章 免责条款
                <p>
                    1、用户应保证，不向其他任何人泄露其在注册时向本网站提交的电子邮箱、用户名、密码及安全问题答案，上述信息是用户在本网站的唯一身份识别信息,请用户妥善保管与自己账户相关的一切信息。如因非本网站原因造成您的账户密码或相关信息泄露的，请应及时通知本网站，以减少可能发生的损失，因上述原因导致的损失需由用户自行承担，与本网站无关。</p>

                <p>
                    2、如用户发现有他人冒用或盗用其账户及密码或进行任何其他未经合法授权行为之情形时，应立即以书面方式通知本网站并请求本网站暂停服务。本网站将积极响应用户的请求，但本网站对已执行的指令及由此导致的损失不承担任何责任。</p>

                <p>
                    3、如果由于本网站及相关第三方的设备、系统故障或缺陷、病毒、黑客攻击、网络故障、网络中断、地震、台风、水灾、海啸、雷电、火灾、暴动、罢工、电力中断、经济形势严重恶化、政府管制或其它类似事件，致使本网站未能履行本协议或履行本协议不符合约定，不构成本网站的违约，对于因此导致的损失，本网站不承担任何责任。</p>
            </div>
