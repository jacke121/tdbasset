    ...
    <div class="col-md-10">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <label>用户名: <input id="idname" type="text" value="{{ old('name') }}" name="name"
                ...
                <input type="button" onclick="search();" class="btn btn-success" style="background-color: #428bca"
                       value="查询"/>
                <iframe name="typescomment" frameborder=0 id="framemember"
                        style="width:1000px;height:750px;scrolling:no;"
